...
function popSurvey() {
    ...
    let submitbtn = "<button class='submit block bg-gray-600 hover:bg-gray-dark text-white uppercase text-lg mx-auto p-4 rounded'type='submit' id='submit'>Submit</button>";
